...
export default function CheckSupabasePage() {
  const [status, setStatus] = useState<ReturnType<typeof checkSupabaseConnection> | null>(null)
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader>
          <CardTitle className="text-2xl">🔗 Nodes — Проверка Supabase</CardTitle>
          <CardDescription>
          ...
          {status && (
            <>
              <div className="space-y-2">
                ...
                <div className={`p-3 rounded-lg ${status.connected ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100'}`}>
              ...
              <div className="space-y-2">
                ...
                {status.user ? (
                  <div className="p-3 bg-muted rounded-lg">
                    ...
                    <p className="font-mono text-xs text-muted-foreground">{status.user.id}</p>
                  </div>
                ) : (
              ...
              {/* Таблицы */}
              <div className="space-y-2">
                <h3 className="font-semibold text-lg">📊 Таблицы базы данных</h3>
              ...
              {status.error && (
                <div className="space-y-2">
                  <h3 className="font-semibold text-lg text-red-600">⚠️ Ошибка</h3>
